...
class MySQLHandler extends AbstractProcessingHandler
{
    ...
    /**
     * @param PDO|null $pdo PDO Connector for the database; when null, the caller must set the pdo property itself
     ...
     * @param bool $skipTableInitialization Skip attempts to alter the database schema
     * @param bool $bubble
     */
